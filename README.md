This Reminder App with PDF Reader Integration is an android based application that allows users to set reminders for tasks and events using pdf reader or manually,
